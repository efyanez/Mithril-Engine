#ifndef _ParticleEffectStream
#define _ParticleEffectStream

#include <string>

#include "ParticleEffect.h"

class ParticleEffectStream : public ParticleEffect
{
public:
	ParticleEffectStream();
